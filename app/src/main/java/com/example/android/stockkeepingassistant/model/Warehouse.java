...
public class Warehouse {
    ...
    private void makeEmailDirectory() {
        ...
        supplierToEmailMap.put(context.getString(R.string.supplier_1), "dmart@gmail.com");
        supplierToEmailMap.put(context.getString(R.string.supplier_2), "bigbazaar@gmail.com");
        supplierToEmailMap.put(context.getString(R.string.supplier_3), "reliance@gmail.com");
        supplierToEmailMap.put(context.getString(R.string.supplier_4), "haiko@gmail.com");
        supplierToEmailMap.put(context.getString(R.string.supplier_5), "naturesbasket@gmail.com");
        supplierToEmailMap.put(context.getString(R.string.supplier_6), "sm@gmail.com");
        supplierToEmailMap.put(context.getString(R.string.supplier_7), "mango@gmail.com");
        supplierToEmailMap.put(context.getString(R.string.supplier_8), "zomato@gmail.com");
        supplierToEmailMap.put(context.getString(R.string.supplier_9), "more@gmail.com");
        supplierToEmailMap.put(context.getString(R.string.supplier_10), "starbaazar@gmail.com");
    }
